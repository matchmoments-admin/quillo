...
const STEPS: Step[] = [
  ...
  {
    title: "4 · Position → hand off",
    body: "Your Dashboard updates as you confirm, then File pulls the year-end position together to print or export for your registered tax agent. Quillo never lodges — your agent does.",
    href: "/dashboard",
    cta: "Open Dashboard",
  },
];
